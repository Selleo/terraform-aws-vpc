...
|------|-------------|------|---------|:--------:|
| <a name="input_availability_zone_identifiers"></a> [availability\_zone\_identifiers](#input\_availability\_zone\_identifiers) | List of availability zone letter identfiers.<br>Current region is automatically prepended for VPC. | `list(string)` | <pre>[<br>  "a",<br>  "b",<br>  "c"<br>]</pre> | no |
